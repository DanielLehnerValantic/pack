		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvalanticpack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvalanticpack-display": {
								"semanticObject": "comvalanticpack",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.valantic.pack",
									"url": sap.ui.require.toUrl("com/valantic/pack")
								}
							}
						}
					}
